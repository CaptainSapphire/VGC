...
def main():
  ...
  Player_height=50
  Player_width=50
  Player_x=int((WIDTH+Player_width)/2) #for start of a level start in the center of a room
  ...
  ob1=obs(manager,pygame.Rect(0,200,75,50),grabable=True)
  
  ob2=obs(manager,pygame.Rect(200,0,100,50))
  
  ob3=obs(manager,pygame.Rect(200,250,100,50),shadow=True)

  ob4=obs(manager,pygame.Rect(125,100,25,100),wall=True)

  ob5=obs(manager,pygame.Rect(0,100,25,100),wall=True)

  ob6=obs(manager,pygame.Rect(200,100,100,25),grabable=True)
  ...
  while True:
    for event in pygame.event.get():
        ...
        if keys[pygame.K_SPACE]:
          if hold==False and PShadow==False:
          ...
          for obj in manager.getobs():
            if obj.grabbed==True:
              ...
              for obj2 in manager.getobs():
                ...
                if obrect.colliderect(ob2) and grabbed2==False and obshad1==obshad2:
                  obrx=obxp+obw
                  obdy=obyp+obh
                  obrx2=obx2+obw2
                  obdy2=oby2+obh2
              ...
              ob=[obx,oby,obw,obh]
              obj.pos=ob
        if keys[pygame.K_LSHIFT] and collidingshadow==False and hold==False:
          player_color=Black
          PShadow=True 
